...
import App1 from 'src/assets/images/landingpage/home/app-chat.jpg';
import App2 from 'src/assets/images/landingpage/home/app-email.jpg';
    ...
    <Slider {...settings} className="dozenscarousel">
      ...
      <div>
        <Box
          ...
          sx={{ boxShadow: (theme) => theme.shadows[10], padding: '0 30px 16px' }}
        >
          <NavLink to="https://modernize-react.adminmart.com/home/chats">
            <img
              src={App1}
              alt="user-img"
              width={380}
      ...
      <div>
        <Box
          ...
          sx={{ boxShadow: (theme) => theme.shadows[10], padding: '0 30px 16px' }}
        >
          <NavLink to="https://modernize-react.adminmart.com/home/email">
            <img
              src={App2}
              alt="user-img"
              width={380}
