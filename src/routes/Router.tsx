...
/* ****Apps***** */
// const Blog = Loadable(lazy(() => import('../views/home/blog/Blog')));
// const BlogDetail = Loadable(lazy(() => import('../views/home/blog/BlogPost')));
const Contacts = Loadable(lazy(() => import('../views/home/contacts/Contacts')));
const Chats = Loadable(lazy(() => import('../views/home/chat/Chat')));
const Notes = Loadable(lazy(() => import('../views/home/notes/Notes')));
const Tickets = Loadable(lazy(() => import('../views/home/tickets/Tickets')));
const Ecommerce = Loadable(lazy(() => import('../views/home/eCommerce/Ecommerce')));
const EcommerceDetail = Loadable(lazy(() => import('../views/home/eCommerce/EcommerceDetail')));
const EcommerceAddProduct = Loadable(
  lazy(() => import('../views/home/eCommerce/EcommerceAddProduct')),
);
const EcommerceEditProduct = Loadable(
  lazy(() => import('../views/home/eCommerce/EcommerceEditProduct')),
);
const EcomProductList = Loadable(lazy(() => import('../views/home/eCommerce/EcomProductList')));
const EcomProductCheckout = Loadable(
  lazy(() => import('../views/home/eCommerce/EcommerceCheckout')),
);
const Calendar = Loadable(lazy(() => import('../views/home/calendar/BigCalendar')));
const UserProfile = Loadable(lazy(() => import('../views/home/user-profile/UserProfile')));
const Followers = Loadable(lazy(() => import('../views/home/user-profile/Followers')));
const Friends = Loadable(lazy(() => import('../views/home/user-profile/Friends')));
const Gallery = Loadable(lazy(() => import('../views/home/user-profile/Gallery')));
const Email = Loadable(lazy(() => import('../views/home/email/Email')));
const InvoiceList = Loadable(lazy(() => import('../views/home/invoice/List')));
const InvoiceCreate = Loadable(lazy(() => import('../views/home/invoice/Create')));
const InvoiceDetail = Loadable(lazy(() => import('../views/home/invoice/Detail')));
const InvoiceEdit = Loadable(lazy(() => import('../views/home/invoice/Edit')));
const Kanban = Loadable(lazy(() => import('../views/home/kanban/Kanban')));
...
const Router = [
  {
    ...
    element: <FullLayout />,
    children: [
      { path: '/', element: <Navigate to="/home/ecommerce/shop" /> },
      { path: '/dashboards/modern', exact: true, element: <ModernDash /> },
      { path: '/dashboards/ecommerce', exact: true, element: <EcommerceDash /> },
      { path: '/home/contacts', element: <Contacts /> },
      // { path: '/home/blog/posts', element: <Blog /> },
      // { path: '/frontend-pages/blog/detail/:id', element: <BlogDetail /> },
      { path: '/home/chats', element: <Chats /> },
      { path: '/home/email', element: <Email /> },
      { path: '/home/notes', element: <Notes /> },
      { path: '/home/tickets', element: <Tickets /> },
      { path: '/home/ecommerce/shop', element: <Ecommerce /> },
      { path: '/home/ecommerce/eco-product-list', element: <EcomProductList /> },
      { path: '/home/ecommerce/eco-checkout', element: <EcomProductCheckout /> },
      { path: '/home/ecommerce/add-product', element: <EcommerceAddProduct /> },
      { path: '/home/ecommerce/edit-product', element: <EcommerceEditProduct /> },
      { path: '/home/ecommerce/detail/:id', element: <EcommerceDetail /> },
      { path: '/home/followers', element: <Followers /> },
      { path: '/home/friends', element: <Friends /> },
      { path: '/home/gallery', element: <Gallery /> },
      { path: '/home/kanban', element: <Kanban /> },
      { path: '/home/invoice/list', element: <InvoiceList /> },
      { path: '/home/invoice/create', element: <InvoiceCreate /> },
      { path: '/home/invoice/detail/:id', element: <InvoiceDetail /> },
      { path: '/home/invoice/edit/:id', element: <InvoiceEdit /> },
